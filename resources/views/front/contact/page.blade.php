...
@section('content')
    ...
    <div class="mt-20">
        <p class="text-center">
            <a class="tracking-wide no-underline text-purple" href="mailto:service@loherb.com.tw">service@loherb.com.tw</a>
        </p>
        <p class="text-center">
            <a class="tracking-wide no-underline text-purple" href="tel:+886-3-959-5685">+886-3-959-5685</a>
        </p>
        <p class="text-center tracking-wide text-purple">
            <a href="https://goo.gl/maps/hruVS5xHAXjfkwqy6" class="text-purple no-underline">
