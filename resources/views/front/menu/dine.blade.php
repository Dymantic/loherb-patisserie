<section id="dine" class="bg-pinky-grey max-w-xl reg-section-space flex flex-col items-center mx-auto">
    ...
    <p class="font-heading text-purple capitalize">{{ trans($menu['dine']['starters']['title']) }}</p>
    ...
    <p class="font-heading text-purple capitalize mb-4">{{ trans($menu['dine']['beverages']['title']) }}</p>
